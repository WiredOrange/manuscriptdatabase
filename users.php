...
<html data-wf-page="622aaf189b2a8f8e266dfe96" data-wf-site="621910c2f2818f47edcbc8e4">
<head>
  <?php
    session_start();
    ...
    <div class="main-block">
      ...
      <div class="w-layout-grid grid-2-1">
        <div id="w-node-ea72df06-1253-e974-3604-5a824884484b-e69909e2" class="card-shadow flex-vertical">
          <div class="dash-item-title grey-3-text"style="color:#002855;font-weight: bold;">Users</div>
            ...
            <?php
              ...
              if($queryResult > 0) {
                while($row = mysqli_fetch_assoc($result)) {
                  ...
                  <a href='profile.php?user=".$row['id']."' class='detail-item'>
                    <div class='legend-label large'>ID: </div>
                    <div class='legend-label'>
                      ".$row['id']."
                    </div>
                    <div class='legend-label large'>Name: </div>
                    <div class='legend-label'>
